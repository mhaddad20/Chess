...
class Game
  ...
  def initialize # initialise our variables
    ...
    $board_pieces[2][1]='wK'# white king


    $board_pieces[0][0]='bK'# black king
  ...
  def moves_king
    ...
    position_black_king
    valid_moves_false
    @turn%2==0 ? king_move('wK',$white_king[0],$white_king[1]) : king_move('bK',$black_king[0],$black_king[1])
  end
  def move(x,y) # update the board on each click
    ...
    reset_squares
    if m.size==0 && move_made
      $type_draw[0]=true
      end_game_draw
    end
    if array.size==2
      valid_moves(array[0],array[1])
      $square_chosen[array[0]][array[1]]=true
    end
  end
end
